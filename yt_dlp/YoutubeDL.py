        ...
        if annofn:
            ...
            if not self.params.get('overwrites', True) and os.path.exists(annofn):
                ...
                try:
                    ...
                    with open(annofn, 'w', encoding='utf-8', buffering=1048576) as annofile:
        ...
        for sub_lang, sub_info in subtitles.items():
            ...
            if sub_info.get('data') is not None:
                try:
                    ...
                    with open(sub_filename, 'w', encoding='utf-8', newline='', buffering=1048576) as subfile:
        ...
        for idx, t in list(enumerate(thumbnails))[::-1]:
            ...
            if existing_thumb:
                ...
                try:
                    ...
                    with open(thumb_filename, 'wb', buffering=1048576) as thumbf:
